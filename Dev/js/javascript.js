...
const buttonG=document.querySelector(".button--email");
...
mainNav.addEventListener('click',(e)=>{
    if (e.target.classList.contains('button-bars') ||e.target.classList.contains('main-menu__text') || e.target.classList.contains('main-menu__icon')) {
